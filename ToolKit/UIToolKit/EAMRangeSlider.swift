...
//  EAMRangeSlider.swift
//  EAMNext
// 
//  Created by NIKTE Mayuri on 23/08/24.
//
...
class SliderHandle: ObservableObject {
    ...
    func updateLocation(for value: Double) {
        let x = CGFloat((value - sliderValueStart) / sliderValueRange) * sliderWidth
        currentLocation = CGPoint(x: x, y: sliderHeight / 2)
        currentPercentage = SliderValue(wrappedValue: (x / sliderWidth))
    }
}
...
struct SliderHandleView: View {
    ...
    var body: some View {
        Circle()
            ...
            .foregroundColor(EAMTheme.eamColors.primary)
...
struct SliderPathBetweenView: View {
    ...
    var body: some View {
        ...
        .stroke(EAMTheme.eamColors.primary, lineWidth: slider.lineWidth)
    }
}
